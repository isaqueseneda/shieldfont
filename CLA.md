# ShieldFont Individual Contributor License Agreement

**Version 1.0 — adapted from the Apache Software Foundation Individual
Contributor License Agreement v2.0.**

Thank you for your interest in ShieldFont ("the Project"), maintained
by Isaque Seneda and Gabriel Abrucio ("the Maintainers"). To clarify
the intellectual property license granted with Contributions from any
person or entity, the Project must have a Contributor License Agreement
...
the license granted herein to the Maintainers and recipients of
...
the Maintainers. For legal entities, the entity making a Contribution
...
intentionally submitted by You to the Maintainers for inclusion in,
or documentation of, the Project. For the purposes of this definition,
"submitted" means any form of electronic, verbal, or written
communication sent to the Maintainers or their representatives,
including but not limited to communication on electronic mailing lists,
source code control systems, and issue tracking systems that are
managed by, or on behalf of, the Maintainers for the purpose of
...
to the Maintainers and to recipients of software distributed by the
...
This grant includes the right for the Maintainers to:

- Distribute Your Contribution under the GNU Affero General Public
  License v3.0 (the Project's current license);
- Distribute Your Contribution under any other open-source license
  approved by the Open Source Initiative; and
- Offer Your Contribution under a separate commercial license to third
  parties, including as part of a hosted service or proprietary
  derivative product, in order to sustain development of the Project.
...
## 4. You are authorized to make the Contribution
...
may submit it to the Maintainers separately from any Contribution,
...
## 8. Keep the Maintainers informed
...
Open a pull request that adds your name, GitHub username, and the date
to the bottom of this file, under the "Signatories" section. A
maintainer will then countersign by merging. Your signature below
indicates agreement to the terms above.
